...
// +kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=ociclusters;ociclusteridentities;ocimachinetemplates,verbs=get;list;watch;create;update;patch;delete
